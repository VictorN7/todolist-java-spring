...
- **Controller**: Expõe os endpoints REST e recebe as requisições.
- **Service**: Concentra as regras de negócio e realiza as operações.
- **Repository**: Responsável pela persistência dos dados.
- **Entity**: Representa o modelo de domínio.
- **Enums**: Definem valores fixos do domínio.
